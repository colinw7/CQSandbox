...
proc init { } {
  #sb::canvas set point_size 3

  sb::canvas set gravity 0.0

  sb::canvas set brush.color black

  sb::canvas set range [list -1.0 -1.0 1.0 1.0]
  ...
  set t1 [sb::image {0 0} "textures/particle1.png"]
